...
@st.cache_data
def load_data():
    base = "https://raw.githubusercontent.com/rtsdque/accutane-analytics/main/processed/"
    df_reac = pd.read_csv(base + "reac_isotretinoin.csv", low_memory=False)
    df_demo = pd.read_csv(base + "demo_isotretinoin.csv", low_memory=False)
    df_drug = pd.read_csv(base + "drug_isotretinoin.csv", low_memory=False)
    df_reddit = pd.read_csv(base + "reddit_nlp.csv", low_memory=False)
    df_ml = pd.read_csv(base + "reddit_ml.csv", low_memory=False)
